...
System.err.println("Reading offsets from ZooKeeper")

		val stopwatch = new Stopwatch()

		val (offsetsRangesStrOpt, _) = ZkUtils.readDataMaybeNull(zkClient, zkPath)

System.err.println("offsetsRangersStrOpt match")

		offsetsRangesStrOpt match {
			case Some(offsetsRangesStr) => 

System.err.println("In case offsetsRangerStr")
...
System.err.println("Done reading offsets from ZooKeeper. Took " + stopwatch)

				Some(offsets)
			case None =>
System.err.println("No offsets found in ZooKeeper. Took " + stopwatch)
				None
		}
	}
